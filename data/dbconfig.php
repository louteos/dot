...
define('G5_MYSQL_USER', 'louteos');
define('G5_MYSQL_PASSWORD', 'g91*02230d');
define('G5_MYSQL_DB', 'louteos');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'sir_');

define('G5_TOKEN_ENCRYPTION_KEY', '44f39c7185561523ff4bbb9208652576'); // 토큰 암호화에 사용할 키
