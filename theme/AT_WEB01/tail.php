...
<div id="ft">
    <div id="ft_wr">
       <div id="ft_sns">
        ...
        <div id="ft_contact">
            <strong>010-9909-3771</strong>
            <p>평일 : 09:30 - 18:10<br />(점심시간 13:20 - 14:20 / 주말, 공휴일 휴무)</p>
        </div>
        <div id="ft_link">
        ...
        <div id="ft_company">
            <ul>
                <li class="ft_company1">상호 : 그린아카데미</li>
                <li class="ft_company2">대표 : 김예슬</li>
                <li class="ft_company3">주소 : 경기도 성남시</li>
                <li class="ft_company4">메일 : dime4110@naver.com</li>
                <li class="ft_company5">사업자등록번호 : 00</li>
                <li class="ft_company6">통신판매업 신고번호 : <a href="javascript:;">[사업자정보확인]</a></li>
            </ul>
        </div>
        
        <div id="ft_copy">
            Copyright &copy; <b>김예슬</b> <span>All rights reserved.</span>
        </div>
    </div>
