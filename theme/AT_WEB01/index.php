...
<div class="bannerWrap">
    <img src="<?php echo G5_THEME_IMG_URL ?>/main/Aesop-US.jpg">
    <div>
        <img class="wow fadeInDown" data-wow-delay="0s" src="<?php echo G5_THEME_IMG_URL ?>/common/Aesop-logo.png">
        <h2 class="wow fadeInDown" data-wow-delay="0.3s">Aesop</h2>
        <p class="wow fadeInDown" data-wow-delay="0.6s">이솝은 세심하게 고안되어 효과적이면서도, 감각적인 즐거움을 선사하는 스킨, 헤어, 바디 케어 제품을 제공합니다.</span></p>
