        ...
        <div class="inner">
            ...
            <div id="logo">
                <a href="<?php echo G5_URL ?>">
                    <img class="logo_pc" src="<?php echo G5_THEME_IMG_URL ?>/common/Aesop-logo.png" alt="<?php echo $config['cf_title']; ?>">
                    <img class="logo_mobile" src="<?php echo G5_THEME_IMG_URL ?>/common/Aesop-logo.png" alt="<?php echo $config['cf_title']; ?>">
                </a>
            </div>
